...
export default function QuotePage() {
  ...
  return (
    <section className="relative bg-[#0d1b3e] min-h-screen overflow-hidden">
      ...
      {/* Glows */}
      <div
        className="absolute right-0 top-0 w-[400px] sm:w-[700px] h-[400px] sm:h-[700px] rounded-full bg-[#1E3A7B] blur-3xl pointer-events-none"
        style={{
      ...
      />
      <div
        className="absolute left-0 bottom-0 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] rounded-full bg-[#C8960A] blur-3xl pointer-events-none"
        style={{
          opacity: loaded ? 0.1 : 0,
          transform: loaded ? "scale(1)" : "scale(0.7)",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-14 sm:py-20 lg:py-28">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          >
            ...
            >
              ...
              >
                Your <span className="text-[#C8960A]">Cargo</span>
              </span>
            </h1>

            <p
              className="text-white/60 text-sm sm:text-base leading-relaxed max-w-md mb-8"
              style={{
                opacity: loaded ? 1 : 0,
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  <div className="w-10 h-10 sm:w-11 sm:h-11 bg-[#C8960A] rounded-xl flex items-center justify-center flex-shrink-0">
                    <Icon size={16} className="text-white" />
                  </div>
                  <div>
                    <p className="text-white/40 text-xs uppercase tracking-widest mb-0.5">{label}</p>
                    <p className="text-white font-semibold text-xs sm:text-sm break-all">{value}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <p
              ...
              style={{ opacity: loaded ? 1 : 0, transition: "opacity 0.6s ease 0.7s" }}
            >
          ...
          {/* RIGHT — Form */}
          <div
            className="bg-white rounded-2xl p-5 sm:p-8 lg:p-10 shadow-2xl"
            style={{
              opacity: loaded ? 1 : 0,
          ...
          >
            {submitted ? (
              <div className="flex flex-col items-center text-center py-10 sm:py-12">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#C8960A]/15 rounded-full flex items-center justify-center mb-5">
                  <CheckCircle2 size={28} className="text-[#C8960A]" />
                </div>
                <h3 className="text-[#081229] text-xl sm:text-2xl font-extrabold mb-2">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:gap-5">
                <div>
                  <h2 className="text-[#081229] text-xl sm:text-2xl font-extrabold mb-1">
                    Request a Quote
                  </h2>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#F8F9FB] border border-[#E2E8F0] rounded-xl pl-10 pr-4 py-3 text-sm text-[#081229] placeholder-gray-400 focus:outline-none focus:border-[#C8960A] focus:ring-2 focus:ring-[#C8960A]/20 transition-all duration-300"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      rows={4} placeholder="Tell us about your shipment needs..."
                      className="w-full bg-[#F8F9FB] border border-[#E2E8F0] rounded-xl pl-10 pr-4 py-3 text-sm text-[#081229] placeholder-gray-400 focus:outline-none focus:border-[#C8960A] focus:ring-2 focus:ring-[#C8960A]/20 transition-all duration-300 resize-none"
                    />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-[#C8960A] hover:bg-[#b8850a] text-white font-semibold text-sm sm:text-base py-3.5 rounded-xl flex items-center justify-center gap-2 transition-all duration-300 mt-1"
                >
                  Submit Request
