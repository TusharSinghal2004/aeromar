        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 bg-[#F0F4FA] rounded-lg flex items-center justify-center mb-6 transition-all duration-300 group-hover:bg-[#1E3A7B]">
          ...
          {/* Featured Dark Card */}
          <div className="group bg-[#1E3A7B] rounded-xl p-7 flex flex-col cursor-pointer transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-[#162d61]">
