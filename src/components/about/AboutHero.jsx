    ...
    <section className="relative min-h-[65vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 lg:px-12 w-full py-16 md:py-20">
        ...
        <div className="max-w-3xl">
          ...
          {/* Heading */}
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white leading-[1.08]">
          ...
          {/* Description */}
          <p className="mt-5 max-w-2xl text-base md:text-lg text-white/80 leading-7">
